This folder contains the result of processing the memaslap logs pertaining to the experiment run in section 2 of Milestone 2 with a set logging ratio of 100.
