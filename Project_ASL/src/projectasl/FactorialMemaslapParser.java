...
public class FactorialMemaslapParser {
...
public static void main(String[] args) throws IOException{
		...
		for(int i=0;i<3;i++){
			...
			for(int rep=1;rep<=reps;rep++){
				...
				for(int client=1;client<=3;client++){
					...
					BufferedReader br = new BufferedReader(new FileReader("M34/m3_5/log_"+client+"_"+num_servers+"_"+seq.get(i)+"_"+rep+"_"+write_prop));
					int count=0;
					while(true){
		...
		FileWriter writer = new FileWriter("M34/m3_5/avg_tps_"+num_servers+"_get_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_std_"+num_servers+"_get_"+write_prop+".csv");
		...
		writer = new FileWriter("M34/m3_5/avg_rep_std_"+num_servers+"_get_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_rt_"+num_servers+"_get_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_rt_std_"+num_servers+"_get_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_tps_"+num_servers+"_set_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_std_"+num_servers+"_set_"+write_prop+".csv");
		...
		writer = new FileWriter("M34/m3_5/avg_rep_std_"+num_servers+"_set_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_rt_"+num_servers+"_set_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_rt_std_"+num_servers+"_set_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_tps_"+num_servers+"_total_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_std_"+num_servers+"_total_"+write_prop+".csv");
		...
		writer = new FileWriter("M34/m3_5/avg_rep_std_"+num_servers+"_total_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_rt_"+num_servers+"_total_"+write_prop+".csv"); 
		...
		writer = new FileWriter("M34/m3_5/avg_rt_std_"+num_servers+"_total_"+write_prop+".csv"); 
