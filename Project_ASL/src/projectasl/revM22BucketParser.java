...
public class revM22BucketParser {
	...
	public static void main(String[] args) throws IOException{
		...
		FileWriter get_fiftywriter = new FileWriter("Rep5_105s_final/rev_bucket_get_50p_"+num_servers+".csv"); 
		get_fiftywriter.write("rep. factor,Get 50 Percentile Resp. Time (us)\n");
		
		FileWriter get_ninetywriter = new FileWriter("Rep5_105s_final/rev_bucket_get_90p_"+num_servers+".csv"); 
		get_ninetywriter.write("rep. factor,Get 90 Percentile Resp.Time (us)\n");
		
		FileWriter get_ninetyninewriter = new FileWriter("Rep5_105s_final/rev_bucket_get_99p_"+num_servers+".csv"); 
		get_ninetyninewriter.write("rep. factor,Get 99 Percentile Resp. Time (us)\n");
		
		FileWriter set_fiftywriter = new FileWriter("Rep5_105s_final/rev_bucket_set_50p_"+num_servers+".csv"); 
		set_fiftywriter.write("rep. factor,Set 50 Percentile Resp. Time (us)\n");
		
		FileWriter set_ninetywriter = new FileWriter("Rep5_105s_final/rev_bucket_set_90p_"+num_servers+".csv"); 
		set_ninetywriter.write("rep. factor,Set 90 Percentile Resp.Time (us)\n");
		
		FileWriter set_ninetyninewriter = new FileWriter("Rep5_105s_final/rev_bucket_set_99p_"+num_servers+".csv"); 
		...
		for(int i=0;i<3;i++){
			...
			for(int rep=1;rep<=5;rep++){
				...
				for(int client=1;client<=3;client++){
					BufferedReader br = new BufferedReader(new FileReader("Rep5_105s_final/m2_2_"+num_servers+"/log_"+client+"_"+num_servers+"_"+seq.get(i)+"_"+rep+"_105s"));
					int count=0;
					while(true){
