...
public class M22MemaslapParser {
...
public static void main(String[] args) throws IOException{
		...
		for(int i=0;i<3;i++){
			...
			for(int rep=1;rep<=5;rep++){
				...
				for(int client=1;client<=3;client++){
					...
					BufferedReader br = new BufferedReader(new FileReader("M22/m2_2_"+num_servers+"/log_"+client+"_"+num_servers+"_"+seq.get(i)+"_"+rep+"_105s"));
					int count=0;
					while(true){
				...
				avg_tps+=rep_avg_tps*0.2;
				avg_rt+=rep_avg_rt*0.2;
				avg_rt_std+=Math.sqrt(rep_avg_rt_std)*0.2;
				repClientAvgTps.add(rep_avg_tps);
				avg_std+=Math.sqrt(rep_avg_std)*0.2;
			
			}
			
			double rep_std=0.0;
			for(int j=0;j<repClientAvgTps.size();j++){
				rep_std+=0.25*(repClientAvgTps.get(j)-avg_tps)*(repClientAvgTps.get(j)-avg_tps);
			}
		...
		FileWriter writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_tps_"+num_servers+"_get.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_std_"+num_servers+"_get.csv");
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rep_std_"+num_servers+"_get.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rt_"+num_servers+"_get.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rt_std_"+num_servers+"_get.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_tps_"+num_servers+"_set.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_std_"+num_servers+"_set.csv");
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rep_std_"+num_servers+"_set.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rt_"+num_servers+"_set.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rt_std_"+num_servers+"_set.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_tps_"+num_servers+"_total.csv"); 
		writer.write("rep. factor,Avg. Agg. TPS (ops/sec)\n");
		for(int i=0;i<3;i++) {
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_std_"+num_servers+"_total.csv");
		writer.write("rep. factor,STDev (ops/sec)\n");
		for(int i=0;i<3;i++) {
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rep_std_"+num_servers+"_total.csv"); 
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rt_"+num_servers+"_total.csv"); 
		writer.write("rep. factor,Avg. Resp. Time (us)\n");
		for(int i=0;i<3;i++) {
		...
		writer = new FileWriter("M22/m2_2_"+num_servers+"/avg_rt_std_"+num_servers+"_total.csv"); 
		writer.write("rep. factor,STDev Resp. Time (us)\n");
		for(int i=0;i<3;i++) {
